<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title><?php echo ($category['cname']); ?>-蔡遵造博客</title><meta name="keywords" content="<?php echo ($category['keywords']); ?>"/><meta property="wb:webmaster" content="3b2dfa1a5c38ed10" /><meta name="description" content="<?php echo ($category['description']); ?>"/><meta http-equiv="Cache-Control" content="no-siteapp"/><meta name="author" content="baijunyao,<?php echo (C("ADMIN_EMAIL")); ?>"><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
            ...
            <div class="col-xs-12 col-md-12 col-lg-12 b-date">
                <ul class="row">
                    ...
                    <li class="col-xs-5 col-md-2 col-lg-2"><i class="fa fa-list-alt"></i> <a
                            href="<?php echo U('Home/Index/category',array('cid'=>$v['cid']));?>" target="_blank"><?php echo ($v['category']['cname']); ?></a>
                    <li class="col-xs-7 col-md-5 col-lg-4 "><i class="fa fa-tags"></i>
                        <?php if(is_array($v['tag'])): foreach($v['tag'] as $key=>$n): ?><a class="b-tag-name"
                                                             href="<?php echo U('Home/Index/tag',array('tid'=>$n['tid']));?>"
                                                             target="_blank"><?php echo ($n['tname']); ?></a><?php endforeach; endif; ?>
                    </li>
                </ul>
            </div>
            <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs">
                        <figure class="b-oa-pic b-style1"><a href="<?php echo ($v['url']); ?>" target="_blank"><img
                                src="<?php echo ($v['pic_path']); ?>" alt="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>"
                                title="<?php echo (C("IMAGE_TITLE_ALT_WORD")); ?>"></a>
                            <figcaption><a href="<?php echo ($v['url']); ?>" target="_blank"></a></figcaption>
                        </figure>
                    </div>
                    <div class="col-xs-12 col-sm-6  col-md-6 col-lg-8 b-des-read"> <?php echo ($v['description']); ?></div>
                </div>
            </div>
            <a class=" b-readall" href="<?php echo ($v['url']); ?>" target="_blank">阅读全文</a></div><?php endforeach; endif; ?>
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12 b-page"> <?php echo ($page); ?></div>
    </div>
