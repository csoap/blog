<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>开源项目-蔡遵造博客</title><meta name="keywords" content="<?php echo (C("WEB_KEYWORDS")); ?>"/><meta property="wb:webmaster" content="3b2dfa1a5c38ed10" /><meta name="description" content="<?php echo (C("WEB_DESCRIPTION")); ?>"/><meta http-equiv="Cache-Control" content="no-siteapp"/><meta name="author" content="baijunyao,<?php echo (C("ADMIN_EMAIL")); ?>"><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
...
<!-- 百度统计结束 --><script src="/Public/static/js/jquery.githubRepoWidget.min.js"></script><script type="text/javascript">
$(function(){
