<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>bjyblog后台管理</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
...
<!-- 百度统计结束 --><script type="text/javascript" src="/Template/default/Admin/Public/js/index.js"></script><script>
