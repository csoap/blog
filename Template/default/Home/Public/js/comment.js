...
function formatNum(e, t) {
    for (var a = "", i = 1; i <= t - e.toString().length; i++)a += "0";
    return a + e
}
function insertHtmlAtCaret(e) {
    var t, a;
    if (window.getSelection) {
        if (t = window.getSelection(), t.getRangeAt && t.rangeCount) {
            ...
            i.innerHTML = e;
            for (var l, s, n = document.createDocumentFragment(); l = i.firstChild;)s = n.appendChild(l);
            a.insertNode(n), s && (a = a.cloneRange(), a.setStartAfter(s), a.collapse(!0), t.removeAllRanges(), t.addRange(a))
        }
    } else document.selection && "Control" != document.selection.type && document.selection.createRange().pasteHTML(e)
}
function comment(e) {
    $.post(check_login, function (t) {
        if (1 == t) {
            var a = $(e).parents(".b-box-textarea").eq(0).find(".b-box-content").html();
            if ("" != a && "请先登录后发表评论" != a) {
                var i = $(e).attr("aid"), l = $(e).attr("pid"), s = $(e).parents(".b-box-textarea").eq(0).find("input[name='email']").val(), n = {
                    aid: i,
                    pid: l,
                    content: a,
                    email: s
                };
                layer.load(1), $.post(ajaxCommentUrl, n, function (t) {
                    var s = t, n = $(e).attr("username"), o = new Date, c = o.getFullYear() + "-" + (o.getMonth() + 1 < 10 ? "0" : "") + (o.getMonth() + 1) + "-" + (o.getDate() < 10 ? "0" : "") + o.getDate() + "&emsp;" + (o.getHours() < 10 ? "0" : "") + o.getHours() + ":" + (o.getMinutes() < 10 ? "0" : "") + o.getMinutes() + ":" + (o.getSeconds() < 10 ? "0" : "") + o.getSeconds(), r = $("#b-login-word .b-head_img").attr("src"), d = $("#b-login-word .b-nickname").text();
                    if (0 == l) {
        ...
        } else $("#b-modal-login").modal("show")
    })
}
function reply(e) {
    var t = $(".b-user-comment").find(".b-box-textarea");
    1 == t.length && t.remove();
    var a = $(e).attr("aid"), i = $(e).attr("pid"), l = $(e).attr("username"), s = '<div class="b-box-textarea"><div class="b-box-content" contenteditable="true" onfocus="delete_hint(this)">请先登录后回复评论</div><ul class="b-emote-submit"><li class="b-emote"><i class="fa fa-smile-o" onclick="getTuzki(this)"></i><input class="form-control b-email" type="text" name="email" placeholder="接收回复的email地址" value="' + userEmail + '"><div class="b-tuzki"></div></li><li class="b-submit-button"><input type="button" value="评 论" aid="' + a + '" pid="' + i + '" username="' + l + '" onclick="comment(this)"></li><li class="b-clear-float"></li></ul></div>';
    $(e).parents(".b-cc-first").eq(0).append(s)
}
function delete_hint(e) {
    var t = $(e).text();
    "请先登录后发表评论" != t && "请先登录后回复评论" != t || ($(e).text(""), $(e).css("color", "#333"))
}
$("html").on("click", ".b-tuzki img", function (e) {
    var t = $(this).prop("outerHTML");
    $(this).parents(".b-box-textarea").eq(0).find(".b-box-content").focus(), insertHtmlAtCaret(t), $(this).parents(".b-tuzki").hide(), tuzkiNumber = 1
});